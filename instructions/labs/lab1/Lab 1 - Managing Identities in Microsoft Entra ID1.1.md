...
1.  On SEA-SVR1, switch to **Microsoft
    Edge**.
...
1.  On SEA-SVR1, in the **Microsoft Entra
...
1.  On ***SEA-SVR1***, switch to Windows
    PowerShell.
...
13. In the Microsoft admin center, in the Navigation pane, expand **Billing** and select **Licenses**.
    ...
    ![A screenshot of a computer Description automaticall generated](./media/image53.png)
...
15. Repeat the same process and assign Office 365 E5 (no Teams) license
    to Contoso_Managers team.
     ...
     both receive their license assignment from their membership in the Contoso_Managers group. You may need to select **Refresh** a couple of
