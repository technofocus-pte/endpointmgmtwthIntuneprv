...
1.  Switch to SEA-SVR1.
    On SEA-SVR1, if necessary, sign in
    as **Contoso\Administrator** with the
    password of !!Pa55w.rd!!  and
...
1.  Switch to SEA-WS3. On the taskbar,
...
3.  On the **Pick an account** page,
    select !!AlexW@M365xXXXXXXX.onmicrosoft.com!!
